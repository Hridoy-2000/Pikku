...
=================================================
Fixed character rendering - characters will appear immediately.
"""
...
.stButton > button:hover { transform: scale(1.03); box-shadow: 0 8px 25px rgba(238,156,167,0.7); }
...
var boy={x:W/2-30,tx:W/2,w:false,lp:0,aw:0,ht:0,mo:false,kf:0,ki:false};
var girl={x:W/2+30,tx:W/2+30,w:false,lp:1,aw:0,ht:0,kf:0,ki:false};
